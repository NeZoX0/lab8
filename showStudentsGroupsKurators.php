...
<body>
    ...
    if($result = $mysqli->query('SELECT u.last_name, p.name,a.keys FROM Users_Account AS s LEFT JOIN groups AS g ON s.grupa_id = g.id INNER JOIN kurators AS k ON g.kurator_id = k.id ORDER BY s.pib')) {   // $mysqli - наш об'єкт, через який здійснюємо підключення, query - метод, який дозволяє виконати довільний запит
    ...
    <ul>
       <li><a href="Users_Account.php">Таблиця user account</a></li>
	   <li><a href="User.php">Таблиця user</a></li>
	   <li><a href="Activation Code.php">Таблиця activation code</a></li> 
	   <li><a href="programs.php">Таблиця programs</a></li>  	
	   <li><a href="manufacturer.php">Таблиця manufacturer</a></li> 
